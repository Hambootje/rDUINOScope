...
float ArcSECstep;
int MicroSteps_360_RA;
int MicroSteps_360_DEC;
...
// #define DAY_NIGHT_PIN A8 // A6

const String FirmwareDate = "28 12 20";
const String FirmwareNumber = "v2.3.1 Hamboo EQ";
const String FirmwareName = "rDUINOScope";
const String FirmwareTime = "00:00:00";
...
int x_cal, y_cal = 0;
//int calx = 7.76, caly = 11.59;
double crx, cby, cx, cy;
double clx = 303;
double cty = 327;
...
void setup(void)
{
  ...
  // below variables are used to calculate the paramters where the drive works
  int wwRA = WORMRA * REDUCTOR;
  int wwDEC = WORMDEC * REDUCTOR;
  ...
  Clock_Sidereal = 1000000 / (MicroSteps_360_RA / SIDEREAL_DAY); // This way I make the interruption occuer 2wice faster than needed - REASON: allow max time for Pin-UP, Pin-DOWN action
  Clock_Solar = 1000000 / (MicroSteps_360_RA / (SIDEREAL_DAY - 235.9095));
  Clock_Lunar = 1000000 / (MicroSteps_360_RA / (SIDEREAL_DAY - 2089.2292));
  ...
  // DRB8825/A4988 - drive mode pins (determine Steppping Modes 1/8, 1/16 and etc.
