...
void considerBTCommands() {
  ...
  if (BT_COMMAND_STR == "Current") {
    ...
    Serial3.print("WORMRA GEAR Tooths = ");
    Serial3.println(WORMRA);
    Serial3.print("WORMDEC GEAR Tooths = ");
    Serial3.println(WORMDEC);
    ...
    Serial3.print("MicroSteps for 360 rotation RA = ");
    Serial3.println(MicroSteps_360_RA);
    Serial3.print("MicroSteps for 360 rotation DEC = ");
    Serial3.println(MicroSteps_360_DEC);
    Serial3.print("RA_90 = ");
